...
author:
 - Javad Zahiri, jzahiri@health.ucsd.edu , URL:https://profiles.ucsd.edu/javad.n.zahiri
...
```{r pssm-ac,echo=FALSE,fig.cap="Figure 2: process of extracting PSSM-AC feature vector from PSSM",out.width = '70%'}
...
<font size="4">In the above equation,$S_{i,j}$'s,are the PSSM elements and $y_{i,j}$'s are the 20x20 matrix elements, which by placing the rows of this matrix next to each other,DPC-PSSM feature vector of length 400 is obtained.</font>
<br></br>
